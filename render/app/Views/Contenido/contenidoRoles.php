                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <h5>Modificar Rol</h5>
                                        <form id="formularioContenidoRol" v-on:submit.prevent="modificarContenidoRol">
                                            <div class="mb-3">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control inputRol" id="Rol" name="Rol">
                                                                <option v-for="docente in arrayRoles" :value="docente.Identificacion">{{docente.Nombre}}
                                                                </option>
                                                            </select>
                                                        </div>
