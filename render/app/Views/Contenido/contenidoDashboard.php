...
<div class="container-fluid py-4">
    <div class="row mt-4">
        <div class="col-lg-6 mb-lg-0 mb-4">
            <div class="card z-index-2 h-100">
                ...
                <div class="card-body p-3">
                    <v-card class="text-center" max-width="100%">
                        <v-card-text>
                            <v-sparkline :value="values" :labels="labels" height="100" auto-draw></v-sparkline>
                        </v-card-text>
                    </v-card>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    <h6 class="text-capitalize">Clientes por Ciudad</h6>

                </div>
                <center>
                    <div class="card-body p-3" style="max-width:46%">
...
<?= $this->include("Archexternos/scriptsDashboard")?>
<?= $this->endSection() ?>