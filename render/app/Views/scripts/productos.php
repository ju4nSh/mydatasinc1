...
var app = new Vue({
    ...
    methods: {
        subcategory: function (id, index) {
            $.ajax({
                url: "http://localhost/mercado/public/detallesCategoria/" + id,
                dataType: "json",
                success: function (response) {
        ...
        atributesCategory: function (param) {
            ...
            // 
            $.ajax({
                url: "http://localhost/mercado/public/atributesCategory/" + param,
                dataType: "json",
                success: function (response) {
                    console.log(response)
        ...
        //         async: false,
        //         type: "post",
        //         url: "http://localhost/mercado/public/actualizarproductoAC",
        ...
        publicarPN: function (param) {
            ...
            $.ajax({
                async: false,
                type: "post",
                url: "http://localhost/mercado/public/publicarPN",
